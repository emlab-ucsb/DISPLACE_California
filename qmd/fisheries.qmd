...
>**Note:** The data included in this repository and presented here are example data based on model output only. It is derived from the actual case study but does not represent real data, as the actual data inputs are confidential.
