...
The current project uses DISPLACE version 1.3.5 on Windows 11. You can download the installer [here](https://displace-project.org/blog/download/). The R routines run on R version 4.5.0 (on any platform or operating system).  
