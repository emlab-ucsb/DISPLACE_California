...
knitr::include_graphics(here::here("docs/figures/validation_fe_distribution.jpg"))
```
...
knitr::include_graphics(here::here("docs/figures/validation_fe_distribution_humboldt.jpg"))
```
...
knitr::include_graphics(here::here("docs/figures/validation_fe_distribution_morrobay.jpg"))
```
...
knitr::include_graphics(here::here("docs/figures/validation_vessel_fit.jpg"))
```
...
knitr::include_graphics(here::here("docs/figures/validation_sp_landings.jpg"))
```
...
knitr::include_graphics(here::here("docs/figures/validation_ssb.jpg"))
```
